...
REM  Created: By Dimpi Sarmah 02-Aug-17 
REM  This script creates users ora1, ora2, ora3 and ora4
...
grant orax to ora2;
grant create job to ora2;
grant create table to ora2;
...
grant orax to ora3;
grant create job to ora3;
grant create table to ora3;
...
grant orax to ora4;
grant create job to ora4;
grant create table to ora4;
